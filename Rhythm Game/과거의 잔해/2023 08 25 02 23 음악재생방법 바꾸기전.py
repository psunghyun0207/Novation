...
while IsRunning:
    ...
    if Window == 'Main' and WindowPlay == 1:
        ...
        Screen.blit(img_main_Title, (w/2 - img_main_Title_Horizon/2, img_main_Title_Vertical/32))
    ...
    if Window == 'Option' and WindowPlay == 1:
        ...
        Screen.blit(img_main_Option, (w/2 - img_Option_Size[0]/2, img_Option_Size[1]/4))
