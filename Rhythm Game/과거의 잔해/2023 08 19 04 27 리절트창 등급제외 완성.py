...
Ratio_Font = pygame.font.Font(None, 50)
...
#커서 세팅
Main_Cursor_Pos = (-50, h/2 - img_main_Start_Vertical * 1.5 - 30)
...
while IsRunning:
    ...
    if Window == 'Main' and WindowPlay == 1:
        ...
        Screen.blit(img_main_Start, (w/36, h/2 - img_main_Start_Vertical * 1.5))
        Screen.blit(img_main_Option, (w/36, h/2))
        Screen.blit(img_main_Exit, (w/36, h/2 + img_main_Exit_Vertical * 1.5))
        Screen.blit(img_main_Guide, (w - img_main_Guide_Horizon, h - img_main_Guide_Vertical))
        Screen.blit(img_main_Title, (w - img_main_Title_Horizon, img_main_Title_Vertical/4))
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_DOWN:
                    ...
                    if Main_Cursor_Current == 'START' and IsPressed_Arrow == 0:
                        Main_Cursor_Pos = (-50, h/2 - 30)
                        Main_Cursor_Current = 'OPTION'
                        IsPressed_Arrow = 1

                    if Main_Cursor_Current == 'OPTION' and IsPressed_Arrow == 0:
                        Main_Cursor_Pos = (-50, h/2 + img_main_Exit_Vertical * 1.5 - 30)
    ...
    if Window == 'Option' and WindowPlay == 1:
        ...
        Screen.blit(img_main_Option, (w/2 - img_main_Option_Horizon/2, img_main_Option_Vertical/4))
    ...
    if Window == 'Result' and WindowPlay == 1:
        ...
        #Set BG
        Screen.blit(img_Background_Main, (0, 0))
        Screen.blit(img_Result_Result, (w/2 - img_Result_Result_Horizon/2, img_Result_Result_Vertical))
        Screen.blit(img_Song_jacket[Current_jacket], (w - w/16 - img_Song_jacket_Horizon, h/2 - h/4))
        Screen.blit(Font_Song_Name, (w - w/16 - Font_Song_Name_Horizon, (h - h/4)))
        ...
        Screen.blit(View_Ratio, (w/20, h/8))
        ...
        Screen.blit(View_Combo, (w/20, h/4))

        Screen.blit(img_Judge_PGREAT, (w/10 - img_Judge_PGREAT_Horizon/2, h/4 + img_Judge_PGREAT_Size[1]))
        Screen.blit(img_Judge_GREAT, (w/10 - img_Judge_GREAT_Horizon/2, h/4 + img_Judge_PGREAT_Size[1]*2))
        Screen.blit(img_Judge_GOOD, (w/10 - img_Judge_GOOD_Horizon/2, h/4 + img_Judge_PGREAT_Size[1]*3))
        Screen.blit(img_Judge_MISS, (w/10 - img_Judge_MISS_Horizon/2, h/4 + img_Judge_PGREAT_Size[1]*4))
        ...
        Screen.blit(PGREAT_Count, (img_Judge_GREAT_Horizon*2, h/4 + img_Judge_PGREAT_Size[1] + 10))
        Screen.blit(GREAT_Count, (img_Judge_GREAT_Horizon*2, h/4 + img_Judge_PGREAT_Size[1]*2 + 10))
        Screen.blit(GOOD_Count, (img_Judge_GREAT_Horizon*2, h/4 + img_Judge_PGREAT_Size[1]*3 + 10))
        Screen.blit(MISS_Count, (img_Judge_GREAT_Horizon*2, h/4 + img_Judge_PGREAT_Size[1]*4 + 10))
