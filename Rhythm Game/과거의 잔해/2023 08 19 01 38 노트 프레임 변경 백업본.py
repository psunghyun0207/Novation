...
img_Note_Frame = [
                ...
                pygame.image.load(r'NOTE\Note_Frame_2.png'), #출처 https://kr.lovepik.com/images/png-1592461149290.html
                pygame.image.load(r'NOTE\Note_Frame_3.png') #출처 https://kr.lovepik.com/images/png-square.html
                ]
...
Hit_Sound = pygame.mixer.Sound(Hit_Sound_Array[Current_Hit_Sound])
    ...
    #COLOR
Note_Frame_Color = WHITE
Current_Note_Frame_Color = 7 - 1
...
while IsRunning:
    ...
    if Window == 'Result':
        ...
        #Draw Ratio
        View_Ratio = Combo_Font.render(str("ACC : %.2f") %Ratio, True, BLACK)
        View_Ratio_Size = View_Ratio.get_size()
        View_Ratio_Horizon = View_Ratio_Size[0]
        View_Ratio_Vertical = View_Ratio_Size[1]

        Screen.blit(View_Ratio, (w/20, h/4))
        ...
        Screen.blit(View_Combo, (w/20, h/4 + h/8))
